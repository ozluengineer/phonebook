...
resource "github_repository_file" "dbendpoint" {
  ...
  content = aws_db_instance.db-server.address # burdaki veriyi file a yazacak
...
resource "aws_launch_template" "asg-lt" {
    ...
    depends_on = [github_repository_file.dbendpoint] # github repository oluşmadan lb oluşmasın diye
    tag_specifications {
